"""Processes the output of Label Studio (in full JSON format) to extract
All the useful information for training and testing models
"""
import json
import sys
import re
...
def main(argv: list[str]):
    """Main function that opens the files and calls the function for processing
    the annotations
    """
